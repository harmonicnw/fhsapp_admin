...
include('php_classes/gen_anno.class.php');
...
<body>
	<div class="wrapper">
		<div class="title_wrapper">
			<h1 id="title">Franklin High School</h1>
			<!--<h2 id="subtitle">Quaker Announcements for (Day), (Month) (Date), (Year)</h2>-->
			<h2 id="subtitle">Quaker Announcements for <?php echo date('l, F jS, Y');?></h2>
		</div>
		...
		<div class="announcement_block" id="impoContinue">
			...
			<ul class="gen_list">
			<?php 
			gen_anno::make_block($ic_anno, "li");
		...
		<div class="announcement_block" id="carColCoun">
			...
			<ul class="gen_list">
			<?php 
			gen_anno::make_block($ccc_anno, "li");
