...
<h3>Help video (no text)</h3>

<h3>Making an announcement</h3>
	<p>To make an announcement, click on the <strong>+</strong> or <strong>Add Annoucement</strong> button in the top bar (picture). The <strong>create</strong> screen will appear. Fields marked with a red asterix are required to be filled for an announcement to be published.</p>
	
	<p>The <strong>Title</strong>is the short tagline that will appear in the non-expanded announcement (pic). The <strong>Description</strong> is a longer explanation of an assignment or announcement. Writing a description is just like writing in a word document. If you need a picture in your announcement, add it here (pic). </p>
	
	<p>The <strong>Starting Date</strong> is the first day you want an announcement to appear. If you want an announcement to appear from March 1st to March 5th, you would set the start date to 3/1/2014, using the pop-up calendar (pic). </p>
	...
	<p>In the right column (pic), you can select the categories (your classes or clubs) that this announcement applies to. Students signed up to the selected categories will see the announcement on their App.</p>
	
	<p>Other information is optional, but may be helpful. Once you have completed the announcement to your satisfaction, click <strong>create announcement.</strong> (pic) To abandon the announcement, click <strong>cancel.</strong></p>
	
<h3>Editing announcements</h3>

	<p>In the <strong>Home</strong> page, you can view all your pending and active announcements. To make edits, simply click the <strong>edit</strong> button.(pic) Clicking <strong>edit</strong> will take you to the <strong>create</strong> page, except with the blank fields filled with that announcement's data. From there, you can make any changes to the announcement you wish. Click <strong>save announcement</strong> to save your changes and return to the home page. </p>
	
	<p>To delete an announcement permanently, click <strong>delete</strong></p>
...
-Making an announcement
	To make an announcement, click on the "+" or "Add Annoucement" button in the top bar (picture). The "create" screen will appear. Fields marked with a red asterix are required to be filled for an announcement to be published.
